...
aligned_cytb_protein = multialign(seqs_cytb_protein_dog_cat_mouse);
distances_cytb_protein = seqpdist(aligned_cytb_protein,'method','jukes-cantor','indels','pair');
phylotree_cytb_protein = seqlinkage(distances_cytb_protein,'single',seqs_cytb_protein_dog_cat_mouse)
plot(phylotree_cytb_protein)

seqs_nadh1_protein_dog_cat_mouse = fastaread('dog_cat_mouse_nadh1_protein.fa');
aligned_nadh1_protein = multialign(seqs_nadh1_protein_dog_cat_mouse);
distances_nadh1_protein = seqpdist(aligned_nadh1_protein,'method','jukes-cantor','indels','pair');
phylotree_nadh1_protein = seqlinkage(distances_nadh1_protein,'single',seqs_nadh1_protein_dog_cat_mouse)
plot(phylotree_nadh1_protein)
